...
/* harmony import */ var _modules_changeColor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/changeColor */ "./src/js/modules/changeColor.js");
/* harmony import */ var _modules_blockChange__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/blockChange */ "./src/js/modules/blockChange.js");
...
window.onload = function () {
  ...
  Object(_modules_changeColor__WEBPACK_IMPORTED_MODULE_2__["default"])();
  Object(_modules_blockChange__WEBPACK_IMPORTED_MODULE_3__["default"])();
};

/***/ }),

/***/ "./src/js/modules/blockChange.js":
/*!***************************************!*\
  !*** ./src/js/modules/blockChange.js ***!
  \***************************************/
...
/* harmony default export */ __webpack_exports__["default"] = (blockChange);
...
var change = function change() {
  var wrap = document.querySelector('.body-html'),
  ...
  function changeColorByClick(e) {
    ...
    // color: rgb(255, 255, 255) --- white
    // color: rgb(0, 0, 0) --- black
    wrap.style.backgroundColor = 'rgb(' + Math.round(Math.random() * 255) + ',' + Math.round(Math.random() * 255) + ',' + Math.round(Math.random() * 255) + ')';
  }

  function changeColorByInput(e) {
    var value = inp.value;
    var req = /^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/gi; //Проверка на hex

    if (!req.test(value)) {
      //Якшо user ввiх не hex
      inp.value = '';
